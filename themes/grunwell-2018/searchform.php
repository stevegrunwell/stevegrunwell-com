...
<form method="get" class="search-form" id="<?php echo esc_attr( $form_id ); ?>" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<input type="search" class="search-field" placeholder="<?php echo esc_html_x( 'Search&hellip;', 'search form placeholder', 'grunwell-2018' ); ?>" name="s" id="<?php echo esc_attr( $fieldid ); ?>" />
