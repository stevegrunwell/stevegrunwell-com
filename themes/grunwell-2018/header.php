...
<html class="no-js" <?php language_attributes(); ?>>
	...
	<body <?php body_class(); ?>>
		...
		<?php if ( is_singular() && ( $banner_id = get_post_meta( get_the_ID(), 'grunwell_banner_id', true ) ) ) :
			$thumb = wp_get_attachment_image_src( $banner_id, 'post-image-cover' );
			?>

			<figure class="header-image bg-image" style="background-image: url( <?php echo esc_url( $thumb[0] ); ?> );">
				<?php echo wp_get_attachment_image( $banner_id, 'post-image-cover' ); ?>
			</figure>
